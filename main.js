...
module.exports = "<ul>\n    <li [class.complete]=\"task.complete\" (click)=\"select(task)\">\n          {{ task.title }}\n          <button (click)=\"remove(i)\">remove</button>\n    </li>\n</ul>"
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.select = function () {
        this.task.complete = !this.task.complete;
    };
    TaskComponent.prototype.remove = function (index) {
        this.tasks.splice(this.index, 1);
    };
    TaskComponent.prototype.add = function (title) {
        this.tasks.push({
            title: title,
            complete: false
        });
...
module.exports = __webpack_require__(/*! /home/raymond/dev/training/angular-to-do-list/src/main.ts */"./src/main.ts");
